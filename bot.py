...
chromedriver_path = '/Users/yankku/Downloads/chromedriver 5' # Change this to your own chromedriver path!
...
notnow = webdriver.find_element_by_css_selector('body > div:nth-child(12) > div > div > div.mt3GC > button.aOOlW.HoLwm')
notnow.click() #comment these last 2 lines out, if you don't get a pop up asking about notifications

sleep(3)


hashtag_list = ['wildlifephotography', 'forest', 'ocean']

prev_user_list = [] #- if it's the first time you run it, use this line and comment the two below
#prev_user_list = pd.read_csv('follow_list.csv', delimiter=',').iloc[:,1:2]  # useful to build a user log
        ...
        for x in range(1, 200):
            ...
            if username not in prev_user_list:
                ...
                if webdriver.find_element_by_css_selector(
                        'body > div._2dDPU.vCf6V > div.zZYga > div > article > header > div.o-MQd > div.PQo_0 > div.bY2yH > button').text == 'Seuraa':

                    webdriver.find_element_by_css_selector(
                        'body > div._2dDPU.vCf6V > div.zZYga > div > article > header > div.o-MQd > div.PQo_0 > div.bY2yH > button').click()
                    ...
                    if comm_prob > 7:
                        comments += 1
                        webdriver.find_element_by_css_selector(
                            'body > div._2dDPU.vCf6V > div.zZYga > div > article > div.eo2As > section.ltpMr.Slqrh > span._15y0l > button > span').click()
